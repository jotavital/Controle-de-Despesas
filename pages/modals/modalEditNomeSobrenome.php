<div class="modal fade" id="modalEditNomeSobrenome" data-bs-backdrop="static" tabindex="-1" aria-labelledby="modalEditNomeSobrenomeLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalEditNomeSobrenomeLabel">Editar dados</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fechar"></button>
            </div>
            <div class="modal-body">
                <div class="container-fluid">
                    <form method="POST" action="../../connections/crud/Usuario.class.php" id="formEditNomeSobrenome">
                        ...
                        <input name="editNomeSobrenome" class="hide">
