        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    ...
                    <p>Saldo atual: <?php echo $functions->formatarReal($newRow['saldo_atual'])?></p>
                    <form method="POST" action="../../classes/Conta.class.php" id="formReajusteSaldo">
                        <div class="col-sm-12 mb-3">
                            ...
                            <input type="text" class="form-control" name="novoSaldoInput" id="novoSaldoInput" value="<?php echo $functions->formatarRealSemCifrao($newRow['saldo_atual']) ?>" onkeypress="$(this).mask('000.000.000,00', {reverse: true});" required>
                        </div>
                        <input name="reajusteSaldo" class="hide">
                        <input name="idConta" class="hide" value="<?php echo $newRow['id'] ?>">
